  ...
  <div class="flex flex-1 flex-col overflow-hidden overflow-y-auto border-b">
    ...
    >
      ...
      >
        ...
        />
        <!-- Add this block to display the site_link as a clickable link -->
        <div v-if="o.field === 'site_link' && ticket[o.field]" class="-m-0.5 min-h-[28px] flex-1 items-center mt-2 overflow-hidden p-0.5 text-base">
          <a :href="ticket[o.field]" target="_blank" class="text-blue-600 underline">
            {{ ticket[o.field] }}
          </a>
        </div>
      </div>
