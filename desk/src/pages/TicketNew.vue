<template>
  <div class="flex flex-col overflow-y-auto">
    ...
    <div v-if="isCustomerPortal" class="h-full mx-5 mb-5">
      <TicketTextEditor
        v-show="(site_link.length > 2 || site_link.length > 0) && (subject.length > 2 || description.length > 0)"
        ref="editor"
    ...
    <!-- for agent portal -->
    <div v-else class="h-full mx-5 mb-5">
      <TicketTextEditor
        ref="editor"
        v-model:attachments="attachments"
        v-model:content="description"
...
const ticket = createResource({
  ...
  validate: (params) => {
    ...
    const toVerify = [...fields, "subject", "site_link", "description"];
